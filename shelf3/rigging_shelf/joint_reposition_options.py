...
class JointRepositionOptions(QtWidgets.QDialog):
    ...
    def show_dialog(cls):
        if cls.__instance is None:
            cls.__instance = JointRepositionOptions()
    ...
    def __init__(self, parent=maya_maya_window()):
        super(JointRepositionOptions, self).__init__(parent)
        
        self.setWindowTitle("Joints reposition options")
    ...
    def __confirm(self, e):
        ...
        jnts.replace_joints_from_locators(aim_vector = aim_vector, up_vector = up_vector)
        ##
...
if __name__ == "__main__":
    ...
    test_dialog = JointRepositionOptions()
    test_dialog.show()