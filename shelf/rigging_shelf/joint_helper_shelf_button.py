...
class JointHelperButton(ShelfButton):
    def __init__(self):
        ...
        self.add_menu_items([
            ...
            MenuItem("Orient constrain in hierarchy", command=self.orient_constrain_in_hierarchy),
    ...
    def orient_constrain_in_hierarchy(self, p):
        jnt.orient_constrain_in_hierarchy_by_selection()
